...
/// A static helper is enough: there's one log for the whole program and no configuration
/// to inject.
/// </summary>
internal static class AppLog
{
    ...
    /// <summary>
    /// The early-pump module fetches candles in parallel, so log lines can arrive from
    /// several threads at once. Without this, two concurrent appends collide, the write
